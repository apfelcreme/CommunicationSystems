 ...
 */
public class DrawableIngredient implements Drawable {
    ...
    public DrawableIngredient(UUID id, String type, int x, int y) {
        this.id = id;
        this.x = x;
        this.y = y;
        try {
            image = ImageIO.read(CommunicationKitchen.class.getResourceAsStream("/"+type.toLowerCase()+".png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
